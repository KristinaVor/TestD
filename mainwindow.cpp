    ...
    :  QMainWindow(parent)
{
    ...
    formLayout->addItem( new QSpacerItem(20, 24, QSizePolicy::Minimum, QSizePolicy::Fixed));
    formLayout->addRow(pushButton);

    messageLayout->addWidget(label_update);
    messageLayout->addSpacerItem(new QSpacerItem(20, 16, QSizePolicy::Minimum, QSizePolicy::Fixed));
    messageLayout->addWidget(label_info);
    messageLayout->addSpacerItem(new QSpacerItem(20, 32, QSizePolicy::Minimum, QSizePolicy::Fixed));
